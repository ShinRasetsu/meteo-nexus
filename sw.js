// APP_CACHE MUST be bumped on every release (v7 → v8 → …): the SW update
// detector only fires when sw.js bytes change, and an unchanged SW serves
...
const APP_CACHE = 'meteonexus-app-v13';
